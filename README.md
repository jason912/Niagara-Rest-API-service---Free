...
| Manual | Description |
|--------|-------------|
| [REST API Guide](docs/Niagara_REST_API_Guide.pdf) | Complete reference for the Niagara REST API |
| [API Comparison](docs/Niagara_API_Comparison_English.pdf) | Comparison between Gline REST API and oBIX |
